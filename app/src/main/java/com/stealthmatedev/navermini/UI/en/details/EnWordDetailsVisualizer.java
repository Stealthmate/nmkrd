...
import com.stealthmatedev.navermini.UI.generic.AdaptableLinearLayout;
...
public class EnWordDetailsVisualizer extends DetailsVisualizer {
    ...
    static void setDefinition(Context context, View root, EnWord.WordClassGroup.Meaning meaning) {
        ...
        exlist.setAdapter(new ExAdapter(context, meaning));
    }
    ...
    public View getView(ViewGroup container) {
        ...
        setDefinition(container.getContext(), view, details.clsgrps.get(0).meanings.get(0));

        AdaptableLinearLayout layout = (AdaptableLinearLayout) view.findViewById(R.id.view_en_detail_word_def_container);
