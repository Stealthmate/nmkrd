 ...
 *
 * Used code from https://gist.github.com/premnirmal/8526542
 */

public class GZipStringRequest extends StringRequest{
    public GZipStringRequest(int method, String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(method, url, listener, errorListener);
    }

    public GZipStringRequest(String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
